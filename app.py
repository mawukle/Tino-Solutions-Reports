...
from sqlalchemy import Column, Integer, String, Float, and_, func, literal_column, desc, select, distinct, create_engine, case, cast, text, or_
...
EXCLUDED_TEAM_MEMBERS = ["Abigail", "Ange", "Belinda", "Gabriel", "Caleb", "Clinton", "Helena", "Intsiful", "Alex", "Elisha", "Fataw", "Emmanuel", "Kristine"]
