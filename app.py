    ...
    try:
        ...
        try:
            ...
            installation_date_data = {
                row.Client_Name: datetime.strptime(row.latest_installation_date, '%Y-%m-%d') if row.latest_installation_date else None
        ...
        clients = [[
            ...
            installation_date_data.get(client.Client_Name, ''),  # Installation Date as datetime
        ...
        clients.sort(key=lambda x: x[11] or datetime.min, reverse=True)  # Column 11 is the installation date
