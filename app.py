            ...
            if project_id:  # Updating an existing project
                ...
                if existing_project:
                    ...
                    project_fields = {
                        ...
                        'kVA': project.get('kVA', existing_project.kVA if project_id else ''),
                        'kWh': project.get('kWh', existing_project.kWh if project_id else ''),
                        'kWp': project.get('kWp', existing_project.kWp if project_id else ''),
